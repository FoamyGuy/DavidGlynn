...
/*
 * Custom Adapter class that is responsible for holding the list of items after they
 * get parsed out of XML and building row views to display them on the screen.
 */
public class itemsAdapter extends ArrayAdapter<NasaFeed> {
	...
	public itemsAdapter(Context ctx, int textViewResourceId, List<NasaFeed> items) {
	...
	public View getView(int pos, View convertView, ViewGroup parent){
		...
		imageLoader.displayImage(getItem(pos).getEnclosure(), iconImg,options, listener);

		//Set the relevant text in our TextViews
		nameTxt.setText(getItem(pos).getTitle());
		aboutTxt.setText(getItem(pos).getDate());
